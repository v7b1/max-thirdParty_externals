...
// tabletCount returns the number tablets that have connected to WacomDriver. It is
// NOT the current number of connected tablets. For an example of determining the number
// currently connected tablets, see awakeFromNib in theTabletControlsController.
+ (UInt32) tabletCount;
