...
//
// Purpose:		Send an Apple Event to the tablet driver to query for the number 
//					of tablets that have connected to Wacom Driver. It is NOT the
//             number of connected tablets. Please see awakeFromNib in
//					TabletControlsController.m to determine the number of connected
//					tablets.
//
