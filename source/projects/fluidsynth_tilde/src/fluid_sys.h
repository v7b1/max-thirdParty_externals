...
#define fluid_curtime() ((unsigned int)gettime())

#define fluid_error() NULL
...
fluid_timer_t* new_fluid_timer(int msec, fluid_timer_callback_t callback, void* data, int new_thread, int auto_destroy);
...
typedef t_systhread_mutex fluid_mutex_t;

#define fluid_mutex_init(_m)      systhread_mutex_new(&(_m), NULL)
#define fluid_mutex_destroy(_m)   systhread_mutex_free(_m)
#define fluid_mutex_lock(_m)      systhread_mutex_lock(_m)
#define fluid_mutex_unlock(_m)    systhread_mutex_unlock(_m)
